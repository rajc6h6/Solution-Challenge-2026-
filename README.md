...
Features
✅ Autonomous agent that monitors shipments 24/7 ✅ Real-time disruption predictions using Gemini AI ✅ Auto-executes reroutes when risk > 70% and confidence > 85% ✅ Escalates to humans when needed ✅ Live dashboard with Firestore real-time listeners ✅ Voice interface for natural language queries ✅ MCP-style tool integration (Gmail, Calendar, Sheets simulation)

Setup Instructions
1. Get Firebase Credentials
A. Get Firebase Client SDK Config
Go to Firebase Console
Select project: skills-63137
...
How It Works
Client-side polling triggers /api/agent/monitor every 5 minutes
Agent fetches active shipments from Firestore (free tier: 50K reads/day)
Gemini AI analyzes weather, traffic, historical data
...
Real-time UI updates via Firestore listeners (no polling needed)
...
Enable Gmail, Calendar, Sheets APIs
Add credentials to .env.local
Set demoMode: false in decision logs
Troubleshooting
